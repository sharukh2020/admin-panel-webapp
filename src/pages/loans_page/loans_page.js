...
import CardContainer from '../../components/loans_page_components/card_container/card_container';
import GetAppIcon from '@material-ui/icons/GetApp';
import CustomizedTablesLoans from '../../components/loans_page_components/loans_table_section/loans_table_section';
               ...
               <Grid item xs={12}>
                 ...
                 <Grid container justifyContent='space-between' alignItems='center' spacing={1}>
                        ...
                        <Grid item xs={12} md={6}>
                            <Grid container className={classes.secondSectionBtnsContainer} spacing={1}>
                                <Grid item xs={12} sm={4} md={6} lg={4} className={classes.manageTopicsBtnContainer}>
                                    <span  style={{textDecoration:'none'}} download>
                                    <Button
                                    variant='contained'
                                    classes={{
